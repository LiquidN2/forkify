...
class RecipeView extends View {
  ...
  _generateMarkupIngredient(ingredient) {
    const qtyFraction = new Fraction(ingredient.quantity);
    return `
        ...
        <div class="recipe__info">
          ...
          <div class="recipe__info-buttons">
            <button data-servings="${this._data.servings - 1}"
              ...
              <svg><use href="img/icons.svg#icon-minus-circle"></use></svg>
            </button>
            
            <button data-servings="${this._data.servings + 1}" 
                    class="btn--tiny btn--update-servings btn--increase-servings">
              <svg><use href="img/icons.svg#icon-plus-circle"></use></svg>
            </button>
          </div>
        </div>
